...
public class CustomerView {
    ...
    /**
     * Initializes Order adding window, where orderField stands for the dropdown menu,
     * nameField, emailField, telNumField* are TextFeild items.
     */
    ...
    public void initialize(){
        ...
        ObservableList<ZakazEntity> orders = new ZakazEntity().select();
        orderField.setItems(orders);
        orderField.getItems().add(null);

        orderField.getSelectionModel().selectFirst();
        fieldListener(nameField, REGEX_NAME_MATCH);
        fieldListener(emailField, REGEX_EMAIL_MATCH);
